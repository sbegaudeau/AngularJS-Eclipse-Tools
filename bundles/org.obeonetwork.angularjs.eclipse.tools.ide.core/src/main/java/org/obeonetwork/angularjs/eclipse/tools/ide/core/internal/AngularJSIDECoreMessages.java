 ...
 *******************************************************************************/
package org.obeonetwork.angularjs.eclipse.tools.ide.core.internal;
...
/**
 * Utility class to access externalized Strings for the AngularJS IDE Core plugin.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 */
public final class AngularJSIDECoreMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.obeonetwork.angularjs.eclipse.tools.ide.core.internal.angularjsidecoremessages"; //$NON-NLS-1$
	 ...
	 */
	private AngularJSIDECoreMessages() {
