 ...
 */
public class AngularJSPackageJsonDependenciesFormPage extends FormPage {
	/**
	 * The identifier of the form page.
	 */
	private static final String FORM_PAGE_ID = "org.obeonetwork.angularjs.eclipse.tools.ide.ui.internal.editors.packagejson.dependencies"; //$NON-NLS-1$

	private DependenciesSection dependenciesSection;

	private BundleDependencies bundleDependenciesSection;

	public AngularJSPackageJsonDependenciesFormPage(FormEditor editor) {
		super(editor, FORM_PAGE_ID, "Dependencies");
	}
	...
	private void fillBody(IManagedForm managedForm, FormToolkit toolkit) {
		...
		this.dependenciesSection = new DependenciesSection(this, body);
		managedForm.addPart(this.dependenciesSection);

		this.bundleDependenciesSection = new BundleDependencies(this, body);
		managedForm.addPart(this.bundleDependenciesSection);
	}
}
