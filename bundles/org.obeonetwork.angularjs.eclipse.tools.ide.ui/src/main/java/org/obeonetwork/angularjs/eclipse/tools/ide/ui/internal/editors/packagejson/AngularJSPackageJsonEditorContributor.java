 ...
 */
public class AngularJSPackageJsonEditorContributor extends MultiPageEditorActionBarContributor {
	 ...
	 */
	public AngularJSPackageJsonEditorContributor() {
		super();
		createActions();
	}
	...
	private void createActions() {
		sampleAction = new Action() {
			@Override
			public void run() {
				MessageDialog.openInformation(null, "AngularJS Eclipse Tools UI", "Sample Action Executed");
			}
		};
		sampleAction.setText("Install the development dependencies");
		sampleAction.setToolTipText("Install the development dependencies");
