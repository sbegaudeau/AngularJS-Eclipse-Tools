 ...
 */
public class DevelopmentDependenciesSection extends AbstractFormPart {
	public DevelopmentDependenciesSection(FormPage formPage, Composite parent) {
		...
		section.setText("Development Dependencies");
