 ...
 */
public class ArchitectureSection extends AbstractFormPart {
	public ArchitectureSection(FormPage formPage, Composite parent) {
		...
		this.createProjectOsEntry(client, toolkit, actionBars);
		this.createProjectCPUEntry(client, toolkit, actionBars);
	}

	private void createProjectOsEntry(Composite client, FormToolkit toolkit, IActionBars actionBars) {
		Label label = toolkit.createLabel(client, "Operating System:"); //$NON-NLS-1$
	...
	private void createProjectCPUEntry(Composite client, FormToolkit toolkit, IActionBars actionBars) {
		Label label = toolkit.createLabel(client, "CPU:"); //$NON-NLS-1$
		label.setForeground(toolkit.getColors().getColor(IFormColors.TITLE));
