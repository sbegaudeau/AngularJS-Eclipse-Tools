...
/**
 * Utility class to access externalized Strings for the AngularJS IDE UI plugin.
 * 
 * @author <a href="mailto:stephane.begaudeau@obeo.fr">Stephane Begaudeau</a>
 */
public final class AngularJSIDEUIMessages {
	/** Qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.obeonetwork.angularjs.eclipse.tools.ide.ui.internal.angularjsideuimessages"; //$NON-NLS-1$
	 ...
	 */
	private AngularJSIDEUIMessages() {
