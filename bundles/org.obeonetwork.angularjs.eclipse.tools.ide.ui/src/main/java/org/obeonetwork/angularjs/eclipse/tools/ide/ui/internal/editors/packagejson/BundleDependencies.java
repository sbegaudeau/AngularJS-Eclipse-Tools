 ...
 */
public class BundleDependencies extends AbstractFormPart {
	public BundleDependencies(FormPage formPage, Composite parent) {
		...
		section.setText("Bundle Dependencies");
